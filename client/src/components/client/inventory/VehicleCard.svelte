...
// login modal stuff
  ...
  onMount( () => {
    ...
    for (let x in userFavorites) {
      if (userFavorites == item._id)
      console.log(userFavorites, item._id)
      favorite = true
  }
